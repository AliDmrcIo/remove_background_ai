...
def load_model():
    ...
    model = torch.hub.load("pytorch/vision:main", "deeplabv3_resnet101", pretrained=True) # pytorch/vision reposundan Hem encoder hem decoder işlemleri yapan DeepLabV3 için olan Resnet101 modelini kur
